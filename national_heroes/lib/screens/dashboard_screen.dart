...
/// Tinggi area teks di bawah foto kartu (nama + tahun + tagline 2 baris).
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  late final List<HeroModel> _ordered;
  String _query = '';
  ...
  void initState() {
    ...
    _ordered = [...heroes]..sort((a, b) => rank(a).compareTo(rank(b)));
  }
        ...
        slivers: [
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: Text(
                'Arsip Tokoh Bangsa',
                style: AppText.serif(32, weight: FontWeight.w700, height: 1.2),
              ),
            ),
          ),
            ...
            SliverPadding(
              ...
              sliver: SliverLayoutBuilder(
                builder: (context, constraints) {
                  // Lebar kartu -> tinggi foto 3:4 + area teks.
                    ...
                    delegate: SliverChildBuilderDelegate(
                      (context, i) {
                        ...
                        return _HeroGalleryCard(
                          hero: hero,
                          number: _ordered.indexOf(hero) + 1,
...
/// Kolom pencarian yang menempel (pinned) di bawah AppBar saat di-scroll.
...
/// Kartu galeri: foto 3:4, nomor, chip provinsi, nama, tahun, tagline.
